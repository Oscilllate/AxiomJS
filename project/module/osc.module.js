 ...
 */
export function cs(type = "log", message = "", prefix = "") {
  const methods = {
    log: console.log,
    warn: console.warn,
    error: console.error,
...
// ===== General Functions =====
export function el(type = "span", attrs = {}) {
...
export function PTT(forKind = Object, methodName, method, { getter = false } = {}) {
...
export function waitFor(conditionFn, { interval = 100, timeout = 5000 } = {}) {
...
// ===== Math Extensions =====
export function range(from = 0, to = 10) {
